...
\title{IgboAI: Self-Updating Research Infrastructure for a Low-Resource, Tonal Language\\[0.4em]\large Version \paperversion}
\author{Ignatius Ezeani\thanks{\todo{affiliation, email, ORCID; add co-authors as they join}}}
\date{\today}
